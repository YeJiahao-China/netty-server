...
public class GlobalCache {
    ...
    public static Map<Integer, Channel> ServerPort_ServerSocketChannel_Map = new ConcurrentHashMap<>();

    // 监听端口与SocketChannel集合
    public static Map<Integer, Set<Channel>> ServerPost_SocketChannelSet_Map = new ConcurrentHashMap<>();
